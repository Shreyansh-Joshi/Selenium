...
public class HReusableMethods {
	...
	{
		fis = new FileInputStream("C:\\Users\\Shreyansh Joshi\\Desktop\\Hybrid Framework.xlsx");
		...
		fos = new FileOutputStream("C:\\Users\\Shreyansh Joshi\\Desktop\\Hybrid Framework.xlsx");
		wbo.write(fos);
	}
	@AfterTest
	public void close()
